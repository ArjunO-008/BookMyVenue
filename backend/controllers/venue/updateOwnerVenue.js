...
//     raw req.body spread; pick allowed keys only to prevent owner overwriting
//     status / owner / editOf / isActive
//
// TODO:
//   1. Find venue by req.params.id where owner === req.user._id and deletedAt === null
...
async function updateOwnerVenue(req, res) {
   // TODO: implement
   return res.status(501).json({ message: "Not implemented" });
}

module.exports = updateOwnerVenue;
